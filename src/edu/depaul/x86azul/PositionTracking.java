...
public class PositionTracking implements LocationListener {
	...
	public PositionTracking(Client activity){
		
		// this is to make sure the activity implements the callback
		mClient = (Context)activity;
		
		// setup the location finder
        mLocationManager = (LocationManager) mClient.getSystemService(Context.LOCATION_SERVICE);
	...
	public void onLocationChanged(Location newLocation) {
		if(isBetterLocation(newLocation, mCurrentLocation)) {
			...
			((Client)mClient).newLocationAlert();
		}
	}
